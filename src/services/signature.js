...
function createAuthSignature(cerBase64, keyPem, password) {
    ...
    // ... (los logs y la lógica de procesar certificados y timestamps no cambian)
    ...
    const xml = `...`; // El XML es el mismo
    console.log('[SIGNATURE] Plantilla XML generada.');

    console.log('[SIGNATURE] Firmando XML...');
    // ****** INICIO DE LA CORRECCIÓN ******
    // Se elimina el 'null' y se pasa un solo objeto de configuración.
